...
const predpovedData = predpoved.find ( (article) => article.id === predpovedID);
...
mainElement.innerHTML += `
    ...
    <p>${predpovedData.ranni_teplota}</p>
    <p>${predpovedData.odpoledni_teplota}</p>
    <p>${predpovedData.vecerni_teplota}</p>
    <p>${predpovedData.stav_pocasi}</p>
  </article>
`;
